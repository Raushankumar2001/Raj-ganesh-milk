...
export default function MuzaffarpurMilkDeliveryPage() {
  const whatsappUrl =
    "https://wa.me/919999999999?text=Namaste%20Raj%20Ganesh%20Dairy%2C%20I%20want%20fresh%20milk%20delivery%20in%20Muzaffarpur.";
    ...
    <main className="bg-milk">
      <section className="relative min-h-[72vh] overflow-hidden bg-cream">
        ...
        <div className="relative mx-auto flex min-h-[72vh] max-w-7xl flex-col justify-center px-4 py-20 sm:px-6 lg:px-8">
          <Link href="/" className="mb-8 inline-flex w-fit rounded-full bg-white/80 px-4 py-2 text-sm font-bold text-leaf">
            Raj Ganesh Dairy
          </Link>
          ...
          <p className="mt-6 max-w-2xl text-lg leading-8 text-ink/72">
            Get clean, local dairy delivered daily across Muzaffarpur. Choose morning milk, monthly plans, paneer, dahi and fresh dairy support on WhatsApp.
          </p>
          <a href={whatsappUrl} className="mt-8 inline-flex h-14 w-fit items-center gap-2 rounded-full bg-leaf px-7 font-extrabold text-white shadow-soft">
      ...
      <section className="py-16">
        <div className="mx-auto grid max-w-7xl gap-6 px-4 sm:px-6 md:grid-cols-3 lg:px-8">
          {[
            [ShieldCheck, "Hygienic handling", "Clean steel utensils and careful packing for family kitchens."],
            [Truck, "Morning delivery", "A steady local route built around breakfast and tea time."],
            [MapPin, "Muzaffarpur focus", "Local service areas, landmarks and subscription support."]
          ].map(([Icon, title, copy]) => (
            <article key={title} className="rounded-[1.5rem] border border-leaf/10 bg-white p-6 shadow-sm">
      ...
      <section className="bg-cream py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold text-ink sm:text-5xl">Areas we serve in Muzaffarpur</h2>
